...
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Luego del cartel de diablitos a la izquierda hasta llegar a una calle ciega', 240);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'frente al CC El llanito', 241);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Al llegar a la plaza tomar 2 izquierdas e ir recto hasta el final', 242);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Sotano del CC El Cacique', 243);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Luego del araguaney ingresar por el porton negro', 244);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Farmatodo', 245);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'McDonalds', 246);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'CC Pradera Seca', 247);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'El crustaceo cascarudo', 248);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Tintoreria siempre limpio', 249);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'KFC', 250);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Luego del cartel de diablitos a la izquierda hasta llegar a una calle ciega', 251);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'frente al CC El llanito', 252);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Al llegar a la plaza tomar 2 izquierdas e ir recto hasta el final', 253);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Sotano del CC El Cacique', 254);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Luego del araguaney ingresar por el porton negro', 255);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Farmatodo', 256);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'McDonalds', 257);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'CC Pradera Seca', 258);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'El crustaceo cascarudo', 259);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Tintoreria siempre limpio', 260);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'KFC', 261);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'Luego del cartel de diablitos a la izquierda hasta llegar a una calle ciega', 262);
insert into PUNTO_REFERENCIA(id_punto_refencia, descripcion_punto_refencia, fk_salon_fiesta) value (null, 'frente al CC El llanito', 263);
