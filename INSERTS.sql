...
insert into PRODUCTO(id_producto, nombre_producto, precio_producto, cantidad_disponible_producto, venta_ind_producto, descuento_producto, fk_categoria) value (null, 'Rosas', 20, 600, 'SI', null, 9);
insert into PRODUCTO(id_producto, nombre_producto, precio_producto, cantidad_disponible_producto, venta_ind_producto, descuento_producto, fk_categoria) value (null, 'Claveles', 20, 600, 'SI', null, 9);
insert into PRODUCTO(id_producto, nombre_producto, precio_producto, cantidad_disponible_producto, venta_ind_producto, descuento_producto, fk_categoria) value (null, 'Margaritas', 20, 600, 'SI', null, 9);
insert into PRODUCTO(id_producto, nombre_producto, precio_producto, cantidad_disponible_producto, venta_ind_producto, descuento_producto, fk_categoria) value (null, 'Girasoles', 20, 600, 'SI', null, 9);
insert into PRODUCTO(id_producto, nombre_producto, precio_producto, cantidad_disponible_producto, venta_ind_producto, descuento_producto, fk_categoria) value (null, 'Palmera', 20, 600, 'SI', null, 9);
