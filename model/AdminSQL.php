...
class AdminSQL extends Connection
{
    ...
    public function add_notary($notary_name, $fk_lugar, $cedula, $latitud, $longitud, $codigo_area, $telefono){
        ...
        $statement->execute();
//        $statement = $this->con->prepare("INSERT INTO $this->coordinates_table (x_coordenada, y_coordenada, fk_notaria) VALUES ($latitud, $longitud, 4);");
//        $statement->execute();
//        $statement = $this->con->prepare("INSERT INTO $this->phone_table (id_telefono, codigo_area_telefono, numero_telefono, fk_notaria) VALUES (null, $codigo_area, $telefono, 4);");
//        $statement->execute();
        // El metodo fetch nos va a devolver el resultado o false en caso de que no haya resultado.
        return $statement->fetchAll();
    }
